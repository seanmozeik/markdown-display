...
export const themeOverrides: Record<string, ThemeOverrides> = {
  ...
  dracula: { bold: '#ff79c6', h1: '#bd93f9', h2: '#ff79c6', h3: '#8be9fd', italic: '#8be9fd' },
  'dracula-soft': {
    bold: '#ff79c6',
    h1: '#bd93f9',
    h2: '#ff79c6',
  ...
  nord: { bold: '#88c0d0', h1: '#88c0d0', h2: '#81a1c1', h3: '#5e81ac', italic: '#81a1c1' },
  'rose-pine': { bold: '#ebbcba', h1: '#c4a7e7', h2: '#ebbcba', h3: '#9ccfd8', italic: '#9ccfd8' },
  'rose-pine-dawn': {
    bold: '#d7827e',
    h1: '#907aa9',
    h2: '#d7827e',
